...
<body>
  <header class="header">
    <div class="header__inner">
      <h1 class="logo"><a href="#"><img src="/assets/img/page/logo.png" alt="PHOTO BOOK 2ページのロゴマーク"></a></h1>
    </div>
  </header>
  <main class="main">
    <div class="main__inner">
      <div class="mv">
        <div class="mv__inner"><img class="mv__img" src="/assets/img/page/mv.png" alt="PHOTO BOOKページのイメージ画像。建物の屋根と青空が強調されて撮影されている。"></div>
      </div>
      <section class="sec sec--index">
        <div class="sec__inner sec__inner--index">
          ...
          <div class="content content--index--bottom">
            <div class="images">
              <div class="images__item"><img src="/assets/img/page/image01.png" alt=""></div>
              <div class="images__item"><img src="/assets/img/page/image02.png" alt=""></div>
              <div class="images__item"><img src="/assets/img/page/image03.png" alt=""></div>
              <div class="images__item"><img src="/assets/img/page/image04.png" alt=""></div>
            </div>
          </div>
        </div>
      </section>
